  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-8 intros text-start">
        <h1 class="display-2"> hi , welcome to
      ...
      <button type="button" class="rounded-pill btn-rounded" onclick="openWhatsApp()">
		  Contact Us
    ...
    <div class="row pt-2 pb-2 mt-0 mb-3">
      <div class="col-md-12">
        <div class="bg-white p-4 text-start">
          <p class="fw-light">
            At Noreply Dev, we create cutting-edge solutions in Machine Learning and Web Development, helping businesses innovate, automate, and grow through technology.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          ...
          <p class="lh-lg">
            We design and build AI-powered solutions, including predictive analytics, 
            natural language processing, and computer vision, to help businesses 
            make smarter decisions and automate complex tasks.
          </p>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
        <div class="services__pic">
          <img src="images/services/service-2.png" alt="machine learning illustration" class="img-fluid">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          ...
          <p class="lh-lg">
            We create fast, secure, and scalable web applications tailored to your business needs. 
            From simple websites to complex platforms, our solutions are built to perform and grow with you.
          </p>
...
<section id="portfolio" class="portfolio">
  <div class="container">
    <div class="row text-center mt-5">
      ...
      <div class="heading-line"></div>
      <p class="lead">
        Showcasing our latest projects in Machine Learning, AI, and Web Development — built to deliver innovation and results.
      </p>
    </div>
    <!-- FILTER BUTTONS  -->
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<section id="contact" class="get-started d-none">
  <div class="container">
    <div class="row text-center">
...
<footer class="footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-lg-6 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">+62881036890504</a>
      ...
      <div class="col-md-6 col-lg-6 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">noreply.development1@gmail.com</a>
  ...
  <div class="footer-sm d-none" style="background-color: #212121;">
    <div class="container">
		...
		<div class="row text-center text-white">
		  <div class="col-12">
			<div class="footer-bottom__copyright">
			  &copy; <span id="year"></span> <a href="#">Noreply Development </a> | All rights reserved
			</div>
		  </div>
		</div>
	  </div>
